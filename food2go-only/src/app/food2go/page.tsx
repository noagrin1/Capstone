      ...
      <div className="space-y-3">
        <div className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-4 shadow-sm">
          ...
          <p className="mt-1 text-sm text-slate-600">
            Demo the full flow: browse &rarr; menu &rarr; cart &rarr; checkout &rarr; tracking &rarr; feedback
          </p>
        </div>
                ...
                <Card interactive>
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-sm text-slate-600">
                        Star {r.rating.toFixed(1)} • {r.etaMinutes}-{r.etaMinutes + 10} min • ${r.deliveryFee.toFixed(2)} delivery
                      </p>
                    </div>
